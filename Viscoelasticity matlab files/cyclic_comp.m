...
d1 = table2array(readtable('BBDINO30_CyclicComp (1).csv')); % swap to another dataset (2 or 3) if needed
d2 = table2array(readtable('BBDINO30_CyclicComp (2).csv'));
d3 = table2array(readtable('BBDINO30_CyclicComp (3).csv'));
