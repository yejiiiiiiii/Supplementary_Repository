...
uni_abaqus = table2array(readtable("BBDINO_Abaqus_Tension_Ogden2.csv"));
...
plan_abaqus = table2array(readtable("BBDINO_Abaqus_PlanarShear_Ogden2.csv"));
...
comp_abaqus = table2array(readtable("BBDINO_Abaqus_Compression_Ogden2.csv"));
...
lb = [zeros(1,2), -10*ones(1,2)];
ub = [ones(1,2)*10,  10*ones(1,2)];

params0 = [0.107776 0.107769 1.953343 1.953525];
