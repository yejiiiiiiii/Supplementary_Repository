% Yeji Han
% Curvefit for Ogden (4th-order) model parameters — Uniaxial, Planar, Compression
...
uni_abaqus = table2array(readtable("BBDINO_Abaqus_Tension_Ogden6.csv"));
...
plan_abaqus = table2array(readtable("BBDINO_Abaqus_PlanarShear_Ogden6.csv"));
...
comp_abaqus = table2array(readtable("BBDINO_Abaqus_Compression_Ogden6.csv"));
...
lb = [zeros(1,6), -10*ones(1,6)];
ub = [ones(1,6)*10,  10*ones(1,6)];

params0 = [0.843628 0.226332 -0.329405 -0.405214 0.183986 -0.013020 1.445799 1.718436 2.283790 2.372444 3.289395 1.935692];
...
fprintf('\nFitted Ogden-6 Parameters:\n');
for i=1:N
    fprintf('μ%d = %.6f\t α%d = %.6f\n',i,mu(i),i,alpha(i));
end

fprintf('\nFitted Ogden-6 Parameters for Abaqus:\n');
for i=1:N
