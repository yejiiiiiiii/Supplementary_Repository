...
uni_abaqus = table2array(readtable("BBDINO_Abaqus_Tension_Ogden4.csv"));
...
plan_abaqus = table2array(readtable("BBDINO_Abaqus_PlanarShear_Ogden4.csv"));
...
comp_abaqus = table2array(readtable("BBDINO_Abaqus_Compression_Ogden4.csv"));
...
lb = [zeros(1,4), -10*ones(1,4)];
ub = [ones(1,4)*10,  10*ones(1,4)];

% params0 = ones(1,8);
params0 = [0.066334 0.066073 0.08618 0.000004 1.790578 1.790952 2.138404 1.914367];
...
fprintf('\nFitted Ogden-4 Parameters:\n');
for i=1:N
    fprintf('μ%d = %.6f\t α%d = %.6f\n',i,mu(i),i,alpha(i));
end

fprintf('\nFitted Ogden-4 Parameters for Abaqus:\n');
for i=1:N
