...
uni_abaqus = table2array(readtable("BBDINO_Abaqus_Tension_Ogden1.csv"));
...
plan_abaqus = table2array(readtable("BBDINO_Abaqus_PlanarShear_Ogden1.csv"));
...
comp_abaqus = table2array(readtable("BBDINO_Abaqus_Compression_Ogden1.csv"));
...
lb = [zeros(1,1), -10*ones(1,1)];
ub = [ones(1,1)*10,  10*ones(1,1)];

params0 = [0.215545 1.953435];
...
a1=params_fit(2); 
mu1_matlab = params_fit(1);
mu1_abaqus = (a1 / 2) * mu1_matlab;
